...
parser.add_argument('--train', required=False, default='../data/label/tt.txt', help='path to train')
parser.add_argument('--test', required=False, default='../data/label/vt.txt', help='path to test')
